...
public partial class releasedbEntities1 : DbContext
{
    ...
    public virtual int S_InsertIntoProject_p(Nullable<int> pid, string pname, Nullable<System.DateTime> exStDate, Nullable<System.DateTime> exEdDate, Nullable<System.DateTime> acStDate, Nullable<System.DateTime> acEdDate)
    {
        ...
        return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("S_InsertIntoProject_p", pidParameter, pnameParameter, exStDateParameter, exEdDateParameter, acStDateParameter, acEdDateParameter);
    }
